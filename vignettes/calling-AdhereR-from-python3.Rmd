...
#### Class `CMA5` and its daughter classes `CMA6`, `CMA6`, `CMA8` and `CMA9`
...
AdhereR 0.1.1 on R 3.4.3 started at 2018-06-04 22:27:10:
...
We can see that things went pretty well, as no exceptions were being thrown and the message starts with a reassuring `Adherer returned code 0`, followed by precisely what `AdhereR` said: 
  ...
  - `AdhereR 0.1.1 on R 3.4.3 started at 2018-06-04 22:27:10:`: first, self-identification (its own version and `R`'s version), followed by the date and time the processing was initated;
...
Out[9]: 
{'code': 0,
 'messages': ['AdhereR 0.1.1 on R 3.4.3 started at 2018-06-04 22:27:10:\n',
  'OK: the results were exported successfully (but there might be warnings and messages above worth paying attention to)!\n']}
...
In [11]: # Plot it (statically):
    ...
    ...:           
Adherer returned code 0 and said:
AdhereR 0.1.0 on R 3.4.3 started at 2018-06-05 13:22:36:
OK: the results were exported successfully (but there might be warnings and messages above worth paying attention to)!
...
<img src="plotting-python.jpg" alt="class hierarchy" style="width: 100%;"/>
...
<img src="plotting-r.jpg" alt="class hierarchy" style="width: 100%;"/>
