...
`AdhereR` leverages the power of `R`'s [`snow`](https://cran.r-project.org/web/packages/snow/index.html) package (as exposed through the `parallel` package) to distribute workloads across a network of computing nodes.
