...
| `plot.xlab`	 | NO | `{'dates':´'Date', 'days':'Days'}` | [dictionary specifying the x labels] | 
| `plot.ylab`	 | NO | `{'withoutCMA'='patient', 'withCMA'='patient (& CMA)'}` | [dictionary specifying the y labels] | 
| `plot.title`	 | NO | `{'aligned'='Event patterns (all patients aligned)', 'notaligned'='Event patterns'}` | [dictionary specifying the title] | 
| `plot.col.cats`	 | NO | `"rainbow"` | [single color (using two quotes, e.g. "'blue'") or a function (quoted, e.g., "rainbow") mapping the categories to colors] | 
| `plot.unspecified.category.label` | NO | `"drug"` | [the label of the unspecified category of medication] | 
| `plot.medication.groups.to.plot` | NO | `"NULL"` | [the names of the medication groups to plot (by default, all)] | 
...
| `plot.show.overlapping.event.intervals`	 | NO | `"first"` | [show the actual prescription intervals; can be: "first", "last", "min gap", "max gap", "average"] | 
