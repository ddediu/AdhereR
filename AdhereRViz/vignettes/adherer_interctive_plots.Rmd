...
The App supports loading data from several file formats:
  ...
  - **SPSS (.sav; .por)**, **SAS Transport data file (.xpt)**, **SAS sas7bdat data file (.sas7bdat)** and **Stata (.dta)**: these are file formats exported by the popular statistical platforms [IBM `SPSS`](https://www.ibm.com/products/spss), [`SAS`](https://www.sas.com) and [`Stata`](https://www.stata.com/)
